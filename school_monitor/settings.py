...
WSGI_APPLICATION = 'school_monitor.wsgi.application'
ASGI_APPLICATION = 'school_monitor.asgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@schoolmonitor.com')
